	...
	return (
		<>
			...
			<div className="Parent">	
				<div className="flex px-2 flex-row justify-end">
					<div className='w-32 m-2 h-32 bg-red-100 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-200 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-300 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-400 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-500 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-600 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-700 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-800 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-800 rounded-lg'></div>
					<div className='w-32 m-2 h-32 bg-red-950 rounded-lg'></div>
				</div>
			</div>
